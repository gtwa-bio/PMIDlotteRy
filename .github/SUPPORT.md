# Getting help with `PMIDlotteRy`

Thank you for using `PMIDlotteRy`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/PMIDlotteRy`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/PMIDlotteRy),
...
[search issues and pull requests](https://github.com/gtwa-bio/PMIDlotteRy/issues)
