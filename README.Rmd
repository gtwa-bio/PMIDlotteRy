...
Below is the citation output from using `citation('PMIDlotteRy')` in R. Please
run this yourself to check for any updates on how to cite __PMIDlotteRy__.

```{r 'citation', eval = requireNamespace('PMIDlotteRy')}
